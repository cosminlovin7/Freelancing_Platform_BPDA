ALICE="../cosmin_testnet_wallet1.pem"
...
deploy() {
    mxpy --verbose contract deploy --bytecode=${PROJECT} --recall-nonce --pem=${ALICE} --gas-limit=50000000 --arguments 0 --send --outfile="deploy-devnet.interaction.json" --proxy=${PROXY} --chain=T || return
